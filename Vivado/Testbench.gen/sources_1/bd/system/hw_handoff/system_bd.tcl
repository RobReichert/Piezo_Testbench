...
proc create_hier_cell_Data_Conversion { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins S_AXIS2] [get_bd_intf_pins conv_0/S_AXIS]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net xadc_read_0_m_axis [get_bd_intf_pins Data_Conversion/S_AXIS2] [get_bd_intf_pins xadc_read_0/m_axis]
  ...
  connect_bd_net -net rst_0_peripheral_aresetn [get_bd_pins Core/S00_ARESETN] [get_bd_pins Data_Conversion/aresetn] [get_bd_pins Memory_IO/aresetn] [get_bd_pins Reg_Brakeout/aresetn] [get_bd_pins ch1_mem_fb_split/aresetn] [get_bd_pins xadc_read_0/aresetn]
  ...
  connect_bd_net -net xadc_read_0_m_drp_daddr [get_bd_pins xadc_read_0/m_drp_daddr] [get_bd_pins xadc_wiz_0/daddr_in]
  connect_bd_net -net xadc_read_0_m_drp_den [get_bd_pins xadc_read_0/m_drp_den] [get_bd_pins xadc_wiz_0/den_in]
  connect_bd_net -net xadc_read_0_m_drp_di [get_bd_pins xadc_read_0/m_drp_di] [get_bd_pins xadc_wiz_0/di_in]
  connect_bd_net -net xadc_read_0_m_drp_dwe [get_bd_pins xadc_read_0/m_drp_dwe] [get_bd_pins xadc_wiz_0/dwe_in]
  connect_bd_net -net xadc_wiz_0_channel_out [get_bd_pins xadc_read_0/channel] [get_bd_pins xadc_wiz_0/channel_out]
  connect_bd_net -net xadc_wiz_0_do_out [get_bd_pins xadc_read_0/m_drp_do] [get_bd_pins xadc_wiz_0/do_out]
  connect_bd_net -net xadc_wiz_0_drdy_out [get_bd_pins xadc_read_0/m_drp_drdy] [get_bd_pins xadc_wiz_0/drdy_out]
  connect_bd_net -net xadc_wiz_0_eoc_out [get_bd_pins xadc_read_0/eoc] [get_bd_pins xadc_wiz_0/eoc_out]
