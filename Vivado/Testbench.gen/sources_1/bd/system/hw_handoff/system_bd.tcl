...
proc create_hier_cell_data_aquisition { parentCell nameHier } {
  ...
  # Create instance: CIC_config_replicator1, and set properties
  set CIC_config_replicator1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 CIC_config_replicator1 ]
  set_property -dict [ list \
   CONFIG.M00_TDATA_REMAP {tdata[15:0]} \
   CONFIG.M01_TDATA_REMAP {tdata[15:0]} \
   CONFIG.M02_TDATA_REMAP {tdata[15:0]} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net CIC_config_replicator1_M00_AXIS [get_bd_intf_pins CIC_config_replicator1/M00_AXIS] [get_bd_intf_pins axis_combiner_0/S02_AXIS]
  connect_bd_intf_net -intf_net CIC_config_replicator1_M01_AXIS [get_bd_intf_pins CIC_config_replicator1/M01_AXIS] [get_bd_intf_pins axis_combiner_0/S04_AXIS]
  connect_bd_intf_net -intf_net CIC_config_replicator1_M02_AXIS [get_bd_intf_pins CIC_config_replicator1/M02_AXIS] [get_bd_intf_pins axis_combiner_0/S05_AXIS]
  connect_bd_intf_net -intf_net CIC_config_replicator1_M03_AXIS [get_bd_intf_pins CIC_config_replicator1/M03_AXIS] [get_bd_intf_pins axis_combiner_0/S06_AXIS]
  connect_bd_intf_net -intf_net CIC_config_replicator1_M04_AXIS [get_bd_intf_pins CIC_config_replicator1/M04_AXIS] [get_bd_intf_pins axis_combiner_0/S07_AXIS]
  ...
  connect_bd_intf_net -intf_net cic_3_M_AXIS_DATA [get_bd_intf_pins CIC_config_replicator1/S_AXIS] [get_bd_intf_pins cic_3/M_AXIS_DATA]
  ...
  # Create port connections
  connect_bd_net -net pll_0_clk_out1 [get_bd_pins aclk] [get_bd_pins CIC_config_replicator/aclk] [get_bd_pins CIC_config_replicator1/aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_constant_0/aclk] [get_bd_pins axis_constant_1/aclk] [get_bd_pins cic_0/aclk] [get_bd_pins cic_1/aclk] [get_bd_pins cic_2/aclk] [get_bd_pins cic_3/aclk]
  connect_bd_net -net rst_0_peripheral_aresetn [get_bd_pins aresetn1] [get_bd_pins CIC_config_replicator/aresetn] [get_bd_pins CIC_config_replicator1/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins cic_0/aresetn] [get_bd_pins cic_1/aresetn] [get_bd_pins cic_2/aresetn] [get_bd_pins cic_3/aresetn]
